...
const MainPage = () => {
  ...
  const handleRefereshStake = async () => {
    ...
    const stakeRes = await getUserStakes(info?.cycle, tokenAddress, info);
  ...
  useEffect(() => {
    ...
    console.log(
      "jjaskjhaskdsahkjsdhdhkshkjsdhkfjh",
      userBalanceData,
      userStakeInfoData
    );
        ...
        <>
          <Container sx={{ py: 4 }}>
            ...
            >
              ...
              <Typography
                variant="caption"
                sx={{ color: "#94A3B8", letterSpacing: "1.5px", mb: 3 }}
              >
                DD : HH : MM : SS
              </Typography>
            </Card>
                  ...
                  <CardContent>
                    ...
                    <Box display="flex" justifyContent="space-between" mb={1}>
                      <Typography variant="body2" sx={{ color: "#94A3B8" }}>
                        Your {`CYCLX  v${info?.cycle}`} Balance
                      </Typography>
                      <IconButton
                        sx={{ color: "#7DC4FF", cursor: "pointer" }}
                        onClick={handleRefereshStake}
                      >
                        <RefreshCw size={16} />
                      </IconButton>
                    </Box>
                    ...
                    <Box mt={2}>
                      ...
                      <Typography variant="h5" sx={{ fontWeight: 600 }}>
                        {/* {String(userBalance)} */}
                        {String(
                          userStakeInfo?.userBalance ?? userBalance ?? "0"
                        ).slice(0, 5)}
                      </Typography>
                    </Box>
                  </CardContent>
                ...
                >
                  <CardContent>
                    ...
                    <Tooltip title={info?.previoustoken || ""}>
                      <Typography
                        sx={{ color: "#94a3b8", mb: 1, cursor: "pointer" }}
                      >
                      ...
                      {info?.phase === "Staking" ? (
                        <>
                          <TextField
                            ...
                            variant="outlined"
                            InputProps={{
                              style: { color: "#E2E8F0", borderRadius: "6px" },
                            }}
                            sx={{ mb: 1 }}
                          />
                          <Typography
